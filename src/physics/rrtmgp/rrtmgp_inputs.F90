...
subroutine rrtmgp_set_state( &
   ...
   type(ty_gas_optics_specification), intent(in) :: kdist_sw
...
subroutine rrtmgp_set_cloud_lw(state, nlwbands, cldfrac, c_cld_lw_abs, lwkDist, cloud_lw)
   ...
   type(ty_gas_optics_specification), intent(in) :: lwkDist
   type(ty_optical_props), intent(inout) :: cloud_lw
...
subroutine rrtmgp_set_aer_lw(ncol, nlwbands, aer_lw_abs, aer_lw)
   ...
   type(ty_optical_props), intent(inout) :: aer_lw
...
subroutine rrtmgp_set_cloud_sw( &
   ...
   ! data in cloud optical properties object are dimensioned (nday,nlay,ngptsw)
...
!*** I think the delta scaling should be applied here.
...
subroutine rrtmgp_set_aer_sw( &
   ...
   ! data in aerosol optical properties object are dimensioned (nday,nlay,nswbands)
