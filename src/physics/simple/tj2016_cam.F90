...
!-----------------------------------------------------------------------
!
! Implement idealized moist Held-Suarez forcings
...
subroutine Thatcher_Jablonowski_init()
   ...
   ! addfld/add_default calls for PRECL and RELHUM are made from diag_init

end subroutine Thatcher_Jablonowski_init

!=========================================================================================

subroutine Thatcher_Jablonowski_precip_tend(state, ptend, ztodt)

   ! precipitation process of the Thatcher-Jablonowski physics (see tj2016.F90)
   ...
   ! relhum was computed by Thatcher_Jablonowski_precip rather than using the calculation
   ! in diag_phys_writeout because the saturation vapor pressure calculation in tj2016
   ! is inconsistent with the one in wv_saturation
   call outfld('RELHUM', relhum, ncol, lchnk)

   call outfld('PRECL', precl, ncol, lchnk)
...
subroutine Thatcher_Jablonowski_sfc_pbl_hs_tend(state, ptend, ztodt, cam_in)
   ...
   ! surface flux and PBL processes of the Thatcher-Jablonowski physics (moist Held-Suarez)
